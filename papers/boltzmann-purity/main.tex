...
\author{Benjamin Guo\\ Hraness (\url{hraness.com})\thanks{The manuscript and its proofs were prepared with AI research agents. The identities and every numerical statement were independently recomputed by the scripts of Section~\ref{sec:verification}; no proof assistant was used.}}
